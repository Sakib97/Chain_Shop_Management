...
insert into employee values(1,'Kaarim',1); 
insert into employee values(2,'Sakib',1);
...
insert into records values(1,2,2,50,'20-SEP-19',1);
insert into records values(1,3,3,45,'20-JAN-18',1);
insert into records values(2,3,5,75,'20-JAN-11',1);
insert into records values(3,5,2,40,'16-JAN-18',2);
insert into records values(2,5,3,60,'19-JAN-18',1);
insert into records values(1,5,1,20,'22-SEP-19',1);
insert into records values(1,1,2,20,'22-SEP-19',1);
insert into records values(2,5,1,20,'22-SEP-19',1);
insert into records values(4,5,1,20,'23-SEP-19',1);
insert into records values(1,1,1,10,'24-SEP-19',1);
insert into records values(5,3,2,30,'24-SEP-19',2);
